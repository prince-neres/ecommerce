...
function MobilMenu({ location, userInfo, logoutHandler, cartItems }) {
  ...
  return (
    <>
      <div className="block sm:hidden items-center p-5" onClick={mobileMenuActive}>
      ...
      <div>
        <div className="sm:hidden flex-col py-5 mobile-menu">
          <Link
            to={'/'}
            className={
              location.pathname === '/' ? 'font-bold' : 'hover:text-dark-orange duration-200'
            }
          >
            <p className="flex">
          ...
          <Link
            to={'/cart'}
            className={location.pathname === '/cart' ? 'font-bold' : 'group duration-200'}
          >
          ...
          {userInfo ? (
            ...
            <Link
              to={'/login'}
              className={
                location.pathname === '/login' ? 'font-bold' : 'hover:text-dark-orange duration-200'
              }
            >
